...
//    }
//
//    public QUESTION(String questionId, String questionHeader, String questionBody, String byUser, Instant postedAt, int upVotes, int downVotes, HashMap<String, Integer> usersInteracted, List<COMMENT> commentObj) {

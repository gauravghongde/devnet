...
//    }
//
//    public ANSWER(String answerId, String answerBody, String byUser, String forQuestion, Instant postedAt, int upVotes, int downVotes, HashMap<String, Integer> usersInteracted, List<COMMENT> commentObj) {
